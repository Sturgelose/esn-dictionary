<script lang='ts'>
	...
	onMount(async () => {
		const request = await fetch('https://docs.google.com/spreadsheets/d/1vUFUH1GR7oKEVxUNtkJ_kFaj5FvgJIWecJMivB07kSo/gviz/tq?tqx=out:json');
...
<template>
	...
	<section class="dictionary">
		<div class="container">
			<div class="row"><anchor name="a"></anchor>
				<div id="dictionary__entries" class="col-lg-6 col-lg-push-3 rhythm">
